...
%prep
%setup -q -n humanfriendly-10.0
cd %{_builddir}/humanfriendly-10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635740321
...
cp %{_builddir}/humanfriendly-10.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/humanfriendly/9d6731576e0d137a6daf04638bb1396bf7303e94
