...
Source0  : https://files.pythonhosted.org/packages/2e/d1/e0d8db85b71fc6e7d5be7d78bb5db64c63790aec45acef6578190d66c666/humanfriendly-8.1.tar.gz
...
%prep
%setup -q -n humanfriendly-8.1
cd %{_builddir}/humanfriendly-8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583532779
...
cp %{_builddir}/humanfriendly-8.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/humanfriendly/4533bebc7b149028bc2932234fc49ca4d1a61d07
