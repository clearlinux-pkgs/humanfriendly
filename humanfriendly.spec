...
Source0  : https://files.pythonhosted.org/packages/bb/ee/c85cca94adc8d6eca6d86802dbffcedf6de7645a69d07d9993a39783f79d/humanfriendly-7.1.1.tar.gz
...
BuildRequires : capturer-python
BuildRequires : coloredlogs-python
...
%prep
%setup -q -n humanfriendly-7.1.1
cd %{_builddir}/humanfriendly-7.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582936543
...
cp %{_builddir}/humanfriendly-7.1.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/humanfriendly/4533bebc7b149028bc2932234fc49ca4d1a61d07
