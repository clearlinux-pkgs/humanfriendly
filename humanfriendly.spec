...
Source0  : https://files.pythonhosted.org/packages/1f/6c/bddbe81bb6b0f03088069ef3a7346be5218cb0689025fa6c6c8dc1886da2/humanfriendly-9.0.tar.gz
...
%prep
%setup -q -n humanfriendly-9.0
cd %{_builddir}/humanfriendly-9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606837706
...
cp %{_builddir}/humanfriendly-9.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/humanfriendly/4533bebc7b149028bc2932234fc49ca4d1a61d07
